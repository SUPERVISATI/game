...
class AudioManager {
    constructor() {
        ...
        // ============================================================
        this.VOLUME_MUSIC = 0.50;      // Música de fundo
        this.VOLUME_COIN = 0.90;       // Coleta de moeda - MAIS ALTO
        this.VOLUME_HIT = 0.45;        // Acerto de alvo
        this.VOLUME_SHOOT = 0.90;      // Disparo - MAIS BAIXO
...
const LEVEL_TARGETS = {
    1: 384, 2: 377, 3: 344, 4: 289, 5: 277,
    6: 261, 7: 249, 8: 238, 9: 222, 10: 203,
    11: 1, 12: 1, 13: 1, 14: 1, 15: 1,
    16: 198, 17: 189, 18: 182, 19: 175, 20: 166
};
...
console.log('🔊 NOVO SISTEMA DE VOLUMES:');
console.log('  🎵 Música de fundo: 0.50 (em loop)');
console.log('  🔫 Disparo: 0.20 (MAIS BAIXO)');
console.log('  💥 Acerto: 0.45 (mais alto que disparo)');
console.log('  🪙 Moeda: 0.90 (MAIS ALTO que todos)');
console.log('  👾 Chefão: 0.50');
console.log('  💢 Dano chefão: 0.35');
console.log('  🔫 Ataque chefão: 0.35');
console.log('📊 HIERARQUIA: Moeda (0.90) > Música (0.50) > Acerto (0.45) > Chefão (0.50) > Dano/Ataque (0.35) > Disparo (0.20)');
